...
printf "\nexport MACHINE_OS_IMAGE_NAME=$RHCOS_OPENSTACK_URI"
printf "\nexport MACHINE_OS_IMAGE_SHA256=$RHCOS_OPENSTACK_SHA_COMPRESSED"
printf "\nexport MACHINE_OS_BOOTSTRAP_IMAGE_NAME=$RHCOS_QEMU_URI"
printf "\nexport MACHINE_OS_BOOTSTRAP_IMAGE_UNCOMPRESSED_SHA256=$RHCOS_QEMU_SHA_UNCOMPRESSED"
...
do
  ...
  USER=$(whoami)
  sudo podman rm -f $IMAGE_CACHE_FOLDER >/dev/null
